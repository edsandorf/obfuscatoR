...
The expected payout to the observer consists of two parts: i) The expected payout from guessing, and ii) the expected payout from not guessing. The first expectation depends on the posterior probabilities calculated in [EQUATION REF], and is calculated using \autoref{eqn-payout-obs}:
