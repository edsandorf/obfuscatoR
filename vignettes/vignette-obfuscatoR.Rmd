...
package: obfuscatoR
abstract: >
  @Chorus2019 puts forward the hypothesis that sometimes when people make choices they wish to hide their true motivation from a potential onlooker. The obfuscatoR  package allows researchers to easily create experimental designs to test the obfuscation hypothesis.
output: 
...
Sandorf, E. D., Chorus, C. & van Cranenburgh, S., 2019, obfuscatoR: An R Package for the Obfuscation Game, https://CRAN.R-project.org/package=obfuscatoR
